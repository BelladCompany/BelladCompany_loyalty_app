...
ALTER TABLE points_ledger ADD CONSTRAINT points_ledger_type_check
  CHECK (type IN ('earn', 'earn_sale', 'earn_service', 'earn_accessory', 'earn_bodyshop', 'earn_referral', 'redeem', 'adjust', 'expire', 'sale', 'service', 'referral', 'correction_applied', 'correction_reversal'));
